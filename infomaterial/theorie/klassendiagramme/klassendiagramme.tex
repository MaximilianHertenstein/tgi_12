...
\begin{center}
\begin {tikzpicture}
\begin{class}[text width =3 cm]{Student}{0 ,0}
...
\begin{center}
\begin {tikzpicture}
\begin{class}[text width =7.5 cm]{Student}{0 ,0}
\attribute {- name: String }
\attribute {- age: Int }
\operation{+ Student(name: String, age: Int)}
...
\begin{class}[text width =5 cm]{Student}{0 ,0}
\attribute {$\vdots$ }
...
\begin{class}[text width =4 cm]{Student}{0 ,0}
\attribute {$\vdots$ }
\operation{$\vdots$ }
%\attribute {+ mainSubject: Subject }
\end{class}

\begin{class}[text width =4.5 cm]{Subject}{10 ,0}
\attribute {- name: String }
...
\begin{class}[text width =5 cm]{Cat}{10 ,0}
\attribute {- lives: Int = 7}
\attribute {$\dots$ }
\end{class}
...
\begin{class}[text width =5 cm]{Utils}{10 ,0}
\attribute {$\dots$ }
\operation{\underline{+ square(x: Int): Int}}
